...
export function prepareCategories() {
  ...
  categories.countries = ['england', 'america', 'canada', 'brazil', 'france', 'russia', 'finland', 'iceland', 'latvia', 'spain', 'germany', 'australia', 'austria', 'mexico', 'madagascar', 'belgium', 'netherlands', 'china', 'japan', 'southKorea', 'northKorea', 'newZealand'];
